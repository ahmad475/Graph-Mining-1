...
g = nx.barabasi_albert_graph(1000, 10, seed=None)
...
plt.suptitle('ba3: Distribution of the local clustering coefficient')
plt.xlabel('K(degree)')
plt.ylabel('Clustering Coefficient')
plt.savefig("ba3scatter.png")
plt.close()
...
plt.suptitle('ba3: Distribution of the shortest path lengths')
plt.xlabel('Path Length')
plt.ylabel('Frequncy')
plt.savefig("ba3barg.png")
plt.close()
